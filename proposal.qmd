...
|                                             |             |           |        |          |                                                                                                                                       |
| Question 2,                                 |             | Yogeshwar | Week 4        |          |                                                                                                                                       |
|                                             |             |           |        |          |                                                                                                                                       |
| Question 3,                                 |             | Sahana    |Week 5        |          |                                                                                                                                       |
|                                             |             |           |        |          |                                                                                                                                       |
| Question 4                                  |             | Sindhu    |Week 6        |          |                                                                                                                                       |
+---------------------------------------------+-------------+-----------+--------+----------+---------------------------------------------------------------------------------------------------------------------------------------+
| Report Writing & Final Project Presentation | Not Started | Sanjeev,  | Week 7 | High     | Compile findings, methods, and conclusions in a formal report. Prepare presentation slides and summary for final project presentation |
|                                             |             |           |        |          |                                                                                                                                       |
|                                             |             | Yogeshwar |        |          |                                                                                                                                       |
|                                             |             |           |        |          |                                                                                                                                       |
|                                             |             | Sahana    |        |          |                                                                                                                                       |
...
```{r}
project-2-pixels-patterns/
├── data/
│   ├── README.md               # Description of data sources and formats
│   ├── raw/                    # Raw data files fetched from `f1dataR`
│   ├── processed/              # Cleaned and prepared data files
├── styles/
│   ├── custom_styles.scss      # Custom styling for the project
│   ├── styles.css              # Compiled CSS file
│   └── README.md               # Documentation for styling
├── documents/
│   ├── proposal.qmd            # Initial project proposal
│   ├── methodology.md          # Detailed project methodology
│   ├── showcase_poster.pptx    # Presentation poster
│   └── README.md               # Description of documents
├── presentation_images/
│   ├── slide1.png              # Images for the presentation
│   ├── slide2.png              # Additional presentation images
│   └── README.md               # Description of presentation images
├── .gitignore                  # Files and folders to be ignored by git
├── README.md                   # Overview of the project and repository
├── _quarto.yml                 # Configuration for Quarto project
├── index.qmd                   # Main Quarto project page
├── presentation.qmd            # Quarto-based presentation
└── analysis/
    ├── data_wrangling.R        # Scripts for data processing
    ├── visualization.R         # Scripts for creating visualizations
    ├── analysis.R              # Analytical calculations
    └── README.md               # Description of analysis scripts
